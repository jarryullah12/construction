...
use App\Http\Controllers\quater_tameer_controller;
  ...
  $total=quater_tameer_controller::cartItem_wood();
?>
@if(Session::has('user'))
    {{ View::make('header')}}
            ...
            <div  class="container-fluid" >
                ...
                <div class="row" >
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-2">
                        <div class="card">
                            <div class="card-body">
                                <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;">اسٹاک ووڈورکس </h3>

<!-- 3rd portion for wood works -->
{{-- <div class="col-lg-12 col-xlg-2 col-md-2">
    <div class="card">

        <div class="card-body">
                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/amad_tameer_quater_wood">
                    @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;">اسٹاک ووڈورکس </h3>
        ...
        <form method="POST" action="/maal_saalas/amad_tameer_quater_wood">
            @csrf
                <div class="form-group fieldGroup">
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 90px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> اڈوانس رقم </b></label>
                            <input type="text"dir="auto" name="advance[]" class="form-control" style="border: 1px solid black" required="required"/>
                            </div>
                            &nbsp;
                            <div style="width: 90px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> ادائیگی </b></label>
                                <input type="text"dir="auto" name="adaighi[]" class="form-control" style="border: 1px solid black" required="required"/>
                                </div>
                                &nbsp;
                        ...
                        <div style="width: 460px">
                         ...
                         <div style="width: 90px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>پیمائش (مربع فٹ)  </b></label>
                            <input type="text"dir="auto" name="murabah_foot[]" class="form-control" style="border: 1px solid black" required="required"/>
                            </div>
                            &nbsp;
                        <div style="width: 90px">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <select type="text"  name="muhala[]" style="text-align: center;  font-family: Jameel Noori;border: 1px solid black;"
                                        ...
                                        class="form-control border-1"   >
                                    <option>سلیکٹ کریں</option> تعمیر کوارٹرز دارالنصر
                        ...
                        <div class="row" >
                            ...
                            <div class="input-group"  >
                                ...
                                <div style="width: 460px">
                                 ...
                                 <div style="width: 90px">
                                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>پیمائش (مربع فٹ)  </b></label>
                                    <input type="text"dir="auto" name="murabah_foot[]" class="form-control" style="border: 1px solid black" required="required" required="required"/>
                                    </div>
                                    &nbsp;
                                <div style="width: 90px">
                                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> ریٹ </b></label>
