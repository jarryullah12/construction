                ...
                <div class="row" style="padding-left: 10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/maal_saalas/amad_quater_letter_list" class="form-horizontal form-material" >
                                    @csrf
                                    <div class="form-group mb-4">
                                        ...
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> تاریخ </b></label>
                                            <input type="text" style="text-align: center;border: 1px solid gray; font-size:20px;" id="cald" name="date"
                                                class="form-control border-1"  placeholder="تاریخ سلیکٹ کریں" required="required">
                                             </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            ...
                                            <select type="text" name="contact_code"
                                                class="form-control select2 " dir="auto"  style="border: 1px solid gray;font-size:20px; width:100px;float: left;" >
                                            ...
                                            <option value="{{"0325"}}">0325</option>
                                                ...
                                                class="form-control border-1" dir="auto"  style="border: 1px solid gray;font-size:20px; width:1100px;float: right;" >
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="quater_no"
                                                class="form-control border-1"  dir="auto" style="border: 1px solid gray;font-size:20px;" required="required">
                                    ...
                                    <div class="form-group mb-4">
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> تفصیل </b></label>
                                                 <div class="col-md-12 border-bottom p-0">
                                                    <textarea name="detail" rows="5" class="form-control  border-1"  dir="auto" style="border: 1px solid gray;font-size:20px;" required="required"></textarea>
