...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_factory_mistri();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
 ...
 {{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_mistri_amad_quater_entry_factory_area">
                @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight: 600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک سول ورکس</h3>
...
<form method="POST" action="/maal_saalas/stock_mistri_amad_quater_entry_factory_area">
    @csrf
        <div class="form-group fieldGroup">
            ...
            <div class="input-group"  >
                ...
                <div style="width: 130px">
                    ...
                    <select  type="text" name="factory_quater_no[]" class="form-control select2" style="border: 1px solid black" >
