        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-yellow" style="background-color: rgb(223, 223, 223)">
                ...
                <div class="row align-items-center">
                    ...
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;" ><b>اسٹاک اسٹیل ڈیکوریٹر فہرست دارالفتوح </b> </h3>
                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/quater_fatuh_steel_list_search">
                                    ...
                                    <tr>
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori; width:130px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_quater_fatuh_steel_entry/" . $col['id']}}>تبدیل کریں</a></button></td>
