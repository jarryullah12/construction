...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_waqfeen_marbel();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
{{-- <div class="col-lg-12 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_waqfeen" class="form-horizontal form-material" method="POST">
                @csrf
...
--}}
<form method="POST" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_waqfeen">
    @csrf
    <h3 style="text-align: center;  font-size: larger; font-size: 25px; font-family: Jameel Noori;"> <strong>ماربل اینڈ چپس کیمیکل پالش </strong> </h3>
