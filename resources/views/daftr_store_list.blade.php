        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-yellow" style="background-color: rgb(223, 223, 223)">
                ...
                <div class="row align-items-center">
                    ...
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;" ><b>  اسٹور دفاتر </b> </h3>
                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/daftr_store_list_search">
                                  ...
                                  <tr>
                                    ...
                                    <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;"><button style="width: 80px;" class="btn btn-danger"><a  style="color: white;" href={{"daftr_store_delete/" . $col->id}}>ختم کریں</a></button></td>
                                    ...
                                    <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:500px;">{{$col['detail_shift']}}</td>
