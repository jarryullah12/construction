                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/thekedar_tameer_list_search">
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:250px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_thekedar_tameer/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        {{-- <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-danger"><a  style="color: white;" href={{"thekedar_tameer_delete/" . $col['id']}}>ختم کریں</a></button></td> --}}
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:200px;">{{$col['thekedar_name']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:180px;">{{$col['muhala']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:350px;">{{$col['date']}}</td>
