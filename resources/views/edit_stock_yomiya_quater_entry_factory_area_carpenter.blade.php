...
<div class="col-lg-12 col-xlg-9 col-md-8">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/edit_stock_yomiya_quater_entry_factory_area_carpenter">
                @csrf
                ...
                <div class="form-group mb-4">
                    <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>  کارپنٹر کا نام </b></label>
                    <div class="col-md-12 border-bottom p-0">
                        <input type="text" name="carpenter_name" value={{$data['carpenter_name']}}
