...
<div>
	<div class="panel panel-default text-center" >
		<div class="panel-body  " >
            ...
            <br>
			<h4 style="text-align:center;font-size:18px;font-family: Jameel Noori;"><strong> بل کارپنٹر یومیہ بنام دفتر تحریک جدید</strong></h4>
...
<br>
			  ...
			  <div class="table-responsive">
				<table style="border: 1px solid black">
                    <tbody>
                        <tr>
							...
							<td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">صرف یوم</td>
							 <td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">   دفاتر کا نام</td>
                    ...
                    <tr>
                    <td dir="auto"><input type="text"  ></td>
                        <td dir="auto">میزان</td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days1"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto" style="font-family: Jameel Noori;"><input type="text" style="font-family: Jameel Noori;" ></td>
