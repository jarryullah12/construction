...
{{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_darul_fatuh">
                @csrf
         ...
         --}}
         <form method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_darul_fatuh">
            @csrf
