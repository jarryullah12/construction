...
use App\Http\Controllers\ishya;
  ...
  $total=ishya::cartItem_decorator();
?>
@if(Session::has('user'))
    {{ View::make('header')}}
    ...
    <link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="card-body">
            <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک اسٹیل ڈیکوریٹر</h3>
                ...
                {{-- <form class="form-horizontal form-material" method="POST" action="/maal_saalas/amad_water_tank_steel">
                    @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک اسٹیل ڈیکوریٹر</h3>
                ...
                <div class="form-group mb-4">
                    <label style="float: right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>  (فی کلو گرام)  وزن </b></label>
                    <div class="col-md-12 border-bottom p-0">
...
<form method="POST" action="/maal_saalas/amad_water_tank_steel">
    @csrf
        <div class="form-group fieldGroup">
            ...
            <div class="input-group"  >
                ...
                <div style="width: 110px">
                    ...
                    <input type="text" name="rate[]" dir="auto"  class="form-control" style="border: 1px solid black" required="required"/>
                    </div>
                    &nbsp;
