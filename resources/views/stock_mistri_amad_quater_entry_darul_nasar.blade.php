...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_nasar_mistri();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
 ...
 {{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_mistri_amad_quater_entry_darul_nasar">
                @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight: 600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک سول ورکس</h3>
                ...
                <div class="form-group mb-4">
                    <label  style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>   کوارٹر نمبر  </b></label>
                                ...
                                <select class="select2 form-control " name="nasar_quater_no" style="border: 1px solid gray;font-size:20px;">
...
<form method="POST" action="/maal_saalas/stock_mistri_amad_quater_entry_darul_nasar">
    @csrf
