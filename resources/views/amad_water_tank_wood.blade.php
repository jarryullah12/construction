...
use App\Http\Controllers\ishya;
  ...
  $total=ishya::cartItem_wood_work();
?>
@if(Session::has('user'))
    {{ View::make('header')}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;">اسٹاک ووڈورکس </h3>
                ...
                {{-- <form class="form-horizontal form-material" method="POST" action="/maal_saalas/amad_water_tank_wood">
                    @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;">اسٹاک ووڈورکس </h3>
        ...
        <form method="POST" action="/maal_saalas/amad_water_tank_wood">
            @csrf
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 90px">
                            ...
                            <div style="width: 90px">
                                ...
                                <input type="text"dir="auto" name="adaigi[]" class="form-control" style="border: 1px solid black" required="required"/>
                                </div>
                                &nbsp;
                        ...
                        <div style="width: 460px">
                         ...
                         <div style="width: 90px">
                            ...
                            <input type="text"dir="auto" name="per_foot[]" class="form-control" style="border: 1px solid black" required="required"/>
                            </div>
                            &nbsp;
                        <div style="width: 90px">
                        ...
                        <div style="width: 200px">
                            ...
                            {{-- <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <select type="text"  name="muhala[]" style="width:130px;text-align: center;  font-family: Jameel Noori;border: 1px solid black;"
