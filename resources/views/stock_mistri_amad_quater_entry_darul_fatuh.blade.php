...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_fatuh_mistri();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<form method="POST" action="/maal_saalas/stock_mistri_amad_quater_entry_darul_fatuh">
    @csrf
                ...
                <div class="row" >
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 130px">
                            ...
                            <select  type="text" name="fatuh_quater_no[]" class="form-control " style="border: 1px solid black" required="required">
