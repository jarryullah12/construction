...
<div>
	<div class="panel panel-default text-center" >
		<div class="panel-body  " >
			...
			<h4 style="text-align:center;font-size:18px;font-family: Jameel Noori;"><strong> بل ووڈورکس بنام تعمیر واٹر ٹینک تحریک جدید</strong></h4>
			<h4 style="text-align:center;font-size:18px;font-family: Jameel Noori;"><strong> تعمیر واٹر ٹینک دارالفتوح  </strong></h4>
        ...
        {{-- <tr>
			...
			<div class="table-responsive">
                    ...
                    {{-- <table style="width:100%;">
                        ...
                        <tr>
                            <th style="text-align: center;width: 100px;font-family: Jameel Noori;">بقایا رقم</th>

                            <td style="font-size:16px;font-family: Jameel Noori;"> {{'thekedar_name'}}</td>
                        </tr>
                    ...
                    <div class="table-responsive">
                        <table >
                            ...
                            <tr style="text-align: center">
                                ...
                                <th style="text-align: center;width: 100px;font-family: Jameel Noori;">قسط</th>
                                <th style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;">سکیورٹی ریٹ</th>

                                <th style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;">اڈوانس رقم</th>
                                <th style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;">ادائیگی</th>

                                <th style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;">ریٹ</th>
                                <th style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;"> کورڈایریا</th>
