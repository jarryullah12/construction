...
<div>
	<div class="panel panel-default text-center" >
		<div class="panel-body  " >
            ...
            <br>
			<h4 style="text-align:center;font-size:18px;font-family: Jameel Noori;"><strong> بل کارپنٹر بنام دفتر تحریک جدید</strong></h4>
				...
				<table style="border: 1px solid black">
                    <tbody>
                        <tr>
							...
							<td style="text-align: center;width: 30px;font-family: Jameel Noori;">ٹوٹل رقم</td>
							<td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">تعداد</td>
							<!-- <td style="text-align: center;width: 100px;font-size:16px;font-family: Jameel Noori;">سائز</td> -->

							<td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">ریٹ</td>
							...
							<td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">صرف یوم</td>
							 <td style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;">  کوارٹر نمبر</td>
							{{-- <th style="text-align: center;width: 30px;font-size:16px;font-family: Jameel Noori;"> مکام </th> --}}
							<td style="text-align: center;width: 20px;font-size:16px;font-family: Jameel Noori;">بروز</td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days2"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days3"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days4"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days5"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days6"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days7"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days8"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days9"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days10"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
                    ...
                    <tr>
                        ...
                        <td dir="auto"><input type="text"  value="" ></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="days11"></td>
                        <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                        <td dir="auto"><input type="text"  ></td>
...
<script>
var rate1 = 1, amount1 = 1, days1 = 1;
var rate1_q=0, amount1_q=0,  size1_q = 0, days1_q = 0;


var rate1Bill="",amount1Bill="", days1Bill="";
...
function showBill(){
    ...
    document.getElementById("total").innerHTML = (rate1*rate1_q*amount1*amount1_q*days1*days1_q); // total amount
}
</script>
...
<script>
    var rate2 = 1, amount2 = 1,  days2 = 1;
    var rate2_q=0, amount2_q=0,  days2_q = 0;


    var rate2Bill="",amount2Bill="",days2Bill="";
    ...
    function showBill2(){
        ...
        document.getElementById("total2").innerHTML = (rate2*rate2_q*amount2*amount2_q*days2*days2_q); // total amount
    }
    </script>
{{-- 3rd --}}

<script>
    var rate3 = 1, amount3 = 1,  days3 = 1;
    var rate3_q=0, amount3_q=0,   days3_q = 0;


    var rate3Bill="",amount3Bill="", days3Bill="";
    ...
    function showBill3(){
        ...
        document.getElementById("total3").innerHTML = (rate3*rate3_q*amount3*amount3_q*days3*days3_q); // total amount
    }
    </script>
{{-- 4th --}}

<script>
    var rate4 = 1, amount4 = 1, days4 = 1;
    var rate4_q=0, amount4_q=0,  days4_q = 0;


    var rate4Bill="",amount4Bill="",days4Bill="";
    ...
    function showBill4(){
        ...
        document.getElementById("total4").innerHTML = (rate4*rate4_q*amount4*amount4_q*days4*days4_q); // total amount
    }
    </script>
{{-- 5th --}}
<script>
    var rate5 = 1, amount5 = 1,  days5 = 1;
    var rate5_q=0, amount5_q=0,   days5_q = 0;


    var rate5Bill="",amount5Bill="",days5Bill="";
    ...
    function showBill5(){
        ...
        document.getElementById("total5").innerHTML = (rate5*rate5_q*amount5*amount5_q*days5*days5_q); // total amount
    }
    </script>
{{-- 6th --}}
<script>
    var rate6 = 1, amount6 = 1, days6 = 1;
    var rate6_q=0, amount6_q=0,   days6_q = 0;


    var rate6Bill="",amount6Bill="", days6ill="";
    ...
    function showBill6(){
        ...
        document.getElementById("total6").innerHTML = (rate6*rate6_q*amount6*amount6_q*days6*days6_q); // total amount
    }
    </script>
{{-- 7th --}}
<script>
    var rate7 = 1, amount7 = 1,  days7 = 1;
    var rate7_q=0, amount7_q=0,  days7_q = 0;
 

    var rate7Bill="",amount7Bill="",days7ill="";
    ...
    function showBill7(){
        ...
        document.getElementById("total7").innerHTML = (rate7*rate7_q*amount7*amount7_q*days7*days7_q); // total amount
    }
    </script>
{{-- 8th --}}
<script>
    var rate8 = 1, amount8 = 1,  days8 = 1;
    var rate8_q=0, amount8_q=0,  days8_q = 0;
    ...
    function showBill8(){
        ...
        document.getElementById("total8").innerHTML = (rate8*rate8_q*amount8*amount8_q*days8*days8_q); // total amount
    }
    </script>
{{-- 9th --}}
<script>
    var rate9 = 1, amount9 = 1, days9 = 1;
    var rate9_q=0, amount9_q=0,   days9_q = 0;


    var rate9Bill="",amount9Bill="", days9ill="";
    ...
    function showBill9(){
        ...
        document.getElementById("total9").innerHTML = (rate9*rate9_q*amount9*amount9_q*days9*days9_q); // total amount
    }
    </script>
{{-- 10th --}}
<script>
    var rate10 = 1, amount10 = 1,  days10 = 1;
    var rate10_q=0, amount10_q=0,   days10_q = 0;


    var rate10Bill="",amount10Bill="",days10ill="";
    ...
    function showBill10(){
        ...
        document.getElementById("total10").innerHTML = (rate10*rate10_q*amount10*amount10_q*days10*days10_q); // total amount
    }
    </script>
{{-- 11th --}}
<script>
    var rate11 = 1, amount11 = 1, days11 = 1;
    var rate11_q=0, amount11_q=0,  days11_q = 0;
...
function showBill11(){
        document.getElementById("total11").innerHTML =
         (rate1*rate1_q*amount1*amount1_q*days1*days1_q)+(rate2*rate2_q*amount2*amount2_q*days2*days2_q)
        +(rate3*rate3_q*amount3*amount3_q*days3*days3_q)+(rate4*rate4_q*amount4*amount4_q*days4*days4_q)
        +(rate5*rate5_q*amount5*amount5_q*days5*days5_q)+(rate6*rate6_q*amount6*amount6_q*days6*days6_q)
        +(rate7*rate7_q*amount7*amount7_q*days7*days7_q)+(rate8*rate8_q*amount8*amount8_q*days8*days8_q)
        +(rate9*rate9_q*amount9*amount9_q*days9*days9_q)+(rate10*rate10_q*amount10*amount10_q*days10*days10_q)
        +(rate11*rate11_q*amount11*amount11_q*days11*days11_q);
}
