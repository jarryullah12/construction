                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/tameer_painter_list_search">
                                    ...
                                    <table id="customers" class="js-serial">
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori; width:300px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_tameer_quater_paint_entry/" . $col['id']}}>تبدیل کریں</a></button></td>
