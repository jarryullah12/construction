        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-yellow" style="background-color: rgb(223, 223, 223)">
                ...
                <div class="row align-items-center">
                    ...
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;" ><b>اسٹاک سول ورکس دفاتر </b> </h3>
                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/stock_store_daftr_mistri_list_search">
                                    ...
                                    <table id="customers" class="js-serial">
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:130px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_stock_amad_entry_daftr_mistri/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        {{-- <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:100px;"><button class="btn btn-danger"><a  style="color: white;" href={{"daftr_mistri_delete/" . $col['id']}}>ختم کریں</a></button></td> --}}
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:180px;">{{$col['mistri_name']}}</td>
