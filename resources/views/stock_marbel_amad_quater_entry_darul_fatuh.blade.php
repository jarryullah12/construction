...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_fatuh_marbel();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
{{-- <div class="col-lg-12 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_fatuh" class="form-horizontal form-material" method="POST">
                @csrf
...
--}}
<form method="POST" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_fatuh">
    @csrf
    <h3 style="text-align: center;  font-size: larger; font-size: 25px; font-family: Jameel Noori;"> <strong>ماربل اینڈ چپس کیمیکل پالش </strong> </h3>
        ...
        <div class="form-group " id="fieldGroupCopy" style="display: none;">
                    ...
                    <div class="row" >
                        ...
                        <div class="input-group"  >
                            ...
                            <div style="width: 60px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> سائز </b></label>
                                <input type="text" dir="auto" name="size[]" class="form-control" style="border: 1px solid black" required="required" required="required"/>
                                </div>
                                &nbsp;
                            <div style="width: 450px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> تفصیل  </b></label>
