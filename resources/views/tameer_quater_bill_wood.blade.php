...
<div class="table-responsive">
    <table >
        ...
        <tr style="text-align: center">
            ...
            <td style="text-align: center;width: 20px;font-size:15px;font-family: Jameel Noori;">اڈوانس رقم</td>
            <td style="text-align: center;width: 20px;font-size:15px;font-family: Jameel Noori;">اداِئیگی</td>
