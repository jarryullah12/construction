...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_steel_sadar();
?>
@if(Session::has('user'))
    {{ View::make('header')}}
...
<form method="POST" action="/maal_saalas/quater_sadar_steel_entry">
    @csrf
            ...
            <div class="input-group"  >
                ...
                <div style="width: 140px">
                    <label style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>
                                ...
                                <select class="form-control select2" name="quater_no[]" style="border: 1px solid gray;font-size:14px;">
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 140px">
                            <label style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>
                                        ...
                                        <select class="form-control " name="quater_no[]" style="border: 1px solid black;font-size:14px;" required="required">
                                           <option style="text-align: center;">سلیکٹ کریں</option>
                                           @foreach ($cols as $col)
                                           <option value="{{$col['quater_no']}}">{{$col['quater_no']}}</option>
                                           @endforeach
                        ...
                        &nbsp;
                        <div style="width: 160px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; " required="required"><b>  تاریخ  </b></label>
                            <input type="text"  name="date[]" class="form-control" class="col-md-2" style="border: 1px solid black" />
                            </div>
                    </div>
