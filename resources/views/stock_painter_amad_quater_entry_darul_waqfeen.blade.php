...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_waqfeen_painter();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<form method="POST" action="/maal_saalas/stock_painter_amad_quater_entry_darul_waqfeen">
    @csrf
            ...
            <div class="input-group"  >
                ...
                <div style="width: 120px">
                    ...
                    <div style="width: 350px">
                        ...
                        <select  type="text" name="kaam[]" class="form-control " style="border: 1px solid black" required="required">
                ...
                <div style="width: 230px">
                    ...
                    <select  type="text" name="waqfeen_quater_no[]" class="form-control select2" style="border: 1px solid black" >
    ...
    <div class="form-group " id="fieldGroupCopy" style="display: none;">
                ...
                <div class="row" >
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 160px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> پینٹر کا نام  </b></label>
                            <input type="text" name="painter_name[]" dir="auto" class="form-control" style="border: 1px solid black" required="required"/>
                            </div>
                            &nbsp;
                            {{-- <div style="width: 120px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> بروز </b></label>
                        ...
                        <div style="width: 230px">
                            ...
                            <select  type="text" name="waqfeen_quater_no[]" class="form-control " style="border: 1px solid black" >
