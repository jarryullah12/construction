@if(Session::has('user'))
                ...
                <div class="row" >
                    ...
                    <div class="col-lg-6 col-xlg-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/bill_tameer_quater_entry_thekedar">
                                    @csrf
  ...
  <div class="col-lg-6 col-xlg-2 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/bill_tameer_quater_entry_steel">
                    @csrf
...
<div class="col-lg-6 col-xlg-2 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/bill_tameer_quater_entry_wood">
                    @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight:600; font-size: 25px; font-family: Jameel Noori;">بل ووڈورکس </h3>
                <div class="form-group mb-4">
                    <label style="float: right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>  تاریخ </b></label>
                    <div class="col-md-12 border-bottom p-0">
...
<div class="col-lg-6 col-xlg-2 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/tameer_bill_entry_painter">
                    @csrf
  ...
  <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/tameer_quater_bill_electric">
                @csrf
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-md-12 border-bottom p-0">
                        <select type="text"  name="muhala" style="text-align: center; font-size: 20px; font-family: Jameel Noori;border: 1px solid gray;"
                            ...
                            class="form-control border-1"   >
                        <option>سلیکٹ کریں</option>
                        <option value="{{"تعمیر کوارٹرز دارالصدر"}}">تعمیر کوارٹر دارالصدر</option>
