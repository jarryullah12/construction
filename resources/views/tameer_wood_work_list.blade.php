                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/tameer_wood_work_list_search">
                                    ...
                                    <table id="customers" class="js-serial">
                                        <tr>
                                            ...
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">اڈوانس </th>
                                            ...
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">پیمائش (مربع فٹ) </th>
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_tameer_wood_work_list/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['adaighi']-$col['advance']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['adaighi']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['advance']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['murabah_foot']*$col['rate']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['rate']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:250px;">{{$col['murabah_foot']}}</td>
