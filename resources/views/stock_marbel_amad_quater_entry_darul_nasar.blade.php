...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_nasar_marbel();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
{{-- <div class="col-lg-12 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_nasar" class="form-horizontal form-material" method="POST">
                @csrf
...
<br><br><br>
                ...
                {{-- <div class="form-group mb-4">
                    ...
                    <div class="col-md-12 border-bottom p-0">
                        <input type="text" name="murbah_rate"
                            class="form-control border-1" style="border: 1px solid gray;font-size:20px;"  dir="auto"  required="required"> </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-md-12 border-bottom p-0">
                        <input type="text" name="per_murbah_rate"
                            class="form-control border-1" style="border: 1px solid gray;font-size:20px;"  dir="auto"  required="required"> </div>
                </div>
...
<form method="POST" action="/maal_saalas/stock_marbel_amad_quater_entry_darul_nasar">
    @csrf
    <h3 style="text-align: center;  font-size: larger; font-size: 25px; font-family: Jameel Noori;"> <strong>ماربل اینڈ چپس کیمیکل پالش </strong> </h3>
        <div class="form-group fieldGroup">
            ...
            <div class="input-group"  >
                ...
                <div style="width: 150px">
                    ...
                    <select  type="text" name="nasar_quater_no[]" class="form-control select2" style="border: 1px solid black" required="required">
                ...
                <div class="row" >
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 60px">
                            ...
                            <div style="width: 100px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> رنگ </b></label>
                                <input type="text" name="color[]" class="form-control" style="border: 1px solid black" required="required"/>
                                </div>
                                &nbsp;
                            <div style="width: 60px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> ریٹ فی بوری </b></label>
                        ...
                        <div style="width: 400px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> تفصیل  </b></label>
                            <textarea type="text" dir="auto" rows="1" name="detail[]" class="form-control" style="border: 1px solid black" ></textarea>
                            </div >
                            &nbsp;
                        <div style="width: 60px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>کل یوم  </b></label>
                        ...
                        <div style="width: 140px">
                            ...
                            <select  type="text" name="nasar_quater_no[]" class="form-control " style="border: 1px solid black" required="required">
