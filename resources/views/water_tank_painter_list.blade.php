                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/water_tank_painter_list_search">
                                    ...
                                    <table id="customers" class="js-serial">
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori; width:300px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_water_tank_paint_entry/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori; width:300px;">{{$col['rakbah']*$col['per_murabah_rate']}}</td>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:300px;">{{$col['date']}}</td>
