                            ...
                            <div class="table-responsive" >
                                ...
                                <div class="topnav">
                                    ...
                                    <table id="customers" class="js-serial">
                                      ...
                                      <tr>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['name_staff']}}</td>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:200px;">{{$col['contact_code']}}{{$col['contact_no']}}</td>

                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:150px;">{{$col['name_letter_person']}}</td>
