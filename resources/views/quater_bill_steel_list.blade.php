				...
				<table style=" border: 1px solid black">
					<thead >
						<tr style="text-align: center">
							<td style="text-align: center;width: 30px;font-size:15px;font-family: Jameel Noori;">ٹوٹل رقم</td>
							<td style="text-align: center;width: 30px;font-size:15px;font-family: Jameel Noori;">وزن</td>
							...
							<td style="text-align: center;width: 30px;font-size:15px;font-family: Jameel Noori;"> کوارٹر نمبر</td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight1"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight2"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight3"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight4"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight5"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight6"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight7"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight8"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight9"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight10"></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text"  id="weight11"></td>
...
{{-- 1st --}}
    ...
    <script>
    var rate1 = 1, amount1 = 1, weight1 = 1;

    var rate1_q=0, amount1_q = 0, weight1_q = 0;


    var rate1Bill="",amount1Bill="",weight1Bill="";
    ...
    document.getElementById("weight1").addEventListener("keyup",function(){
    if(this.value==""||this.value==0){
        weight1Bill="";
        weight1_q=0;
        showBill();
    }else{
        weight1_q=this.value;
        weight1Bill="";
        showBill();
    ...
    function showBill(){
        ...
        document.getElementById("total").innerHTML = (rate1*rate1_q*amount1*amount1_q*weight1*weight1_q); // total amount
    }
    </script>
    ...
    <script>
        var rate2 = 1, amount2 = 1, weight2 = 1;

        var rate2_q=0, amount2_q = 0, weight2_q = 0;


        var rate2Bill="",amount2Bill="",weight2Bill="";
        ...
        document.getElementById("weight2").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight2Bill="";
            weight2_q=0;
            showBill2();
        }else{
            weight2_q=this.value;
            weight2Bill="";
            showBill2();
        ...
        function showBill2(){
            ...
            document.getElementById("total2").innerHTML = (rate2*rate2_q*amount2*amount2_q*weight2*weight2_q); // total amount
        }
        </script>
    {{-- 3rd --}}

    <script>
        var rate3 = 1, amount3 = 1, weight3 = 1;

        var rate3_q=0, amount3_q = 0, weight3_q = 0;


        var rate3Bill="",amount3Bill="",weight3Bill="";
        ...
        document.getElementById("weight3").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight3Bill="";
            weight3_q=0;
            showBill3();
        }else{
            weight3_q=this.value;
            weight3Bill="";
            showBill3();
        ...
        function showBill3(){
            ...
            document.getElementById("total3").innerHTML = (rate3*rate3_q*amount3*amount3_q*weight3*weight3_q); // total amount
        }
        </script>
    {{-- 4th --}}

    <script>
        var rate4 = 1, amount4 = 1, weight4 = 1;

        var rate4_q=0, amount4_q = 0, weight4_q = 0;


        var rate4Bill="",amount4Bill="",weight4Bill="";
        ...
        document.getElementById("weight4").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight4Bill="";
            weight4_q=0;
            showBill4();
        }else{
            weight4_q=this.value;
            weight4Bill="";
            showBill4();
        ...
        function showBill4(){
            ...
            document.getElementById("total4").innerHTML = (rate4*rate4_q*amount4*amount4_q*weight4*weight4_q); // total amount
        }
        </script>
    {{-- 5th --}}
    <script>
        var rate5 = 1, amount5 = 1, weight5 = 1;

        var rate5_q=0, amount5_q = 0, weight5_q = 0;


        var rate5Bill="",amount5Bill="",weight5Bill="";
        ...
        document.getElementById("weight5").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight5Bill="";
            weight5_q=0;
            showBill5();
        }else{
            weight5_q=this.value;
            weight5Bill="";
            showBill5();
        ...
        function showBill5(){
            ...
            document.getElementById("total5").innerHTML = (rate5*rate5_q*amount5*amount5_q*weight5*weight5_q); // total amount
        }
        </script>
    {{-- 6th --}}
    <script>
        var rate6 = 1, amount6 = 1, weight6 = 1;

        var rate6_q=0, amount6_q = 0, weight6_q = 0;


        var rate6Bill="",amount6Bill="",weight6Bill="";
        ...
        document.getElementById("weight6").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight6Bill="";
            weight6_q=0;
            showBill6();
        }else{
            weight6_q=this.value;
            weight6Bill="";
            showBill6();
        ...
        function showBill6(){
            ...
            document.getElementById("total6").innerHTML = (rate6*rate6_q*amount6*amount6_q*weight6*weight6_q); // total amount
        }
        </script>
    {{-- 7th --}}
    <script>
        var rate7 = 1, amount7 = 1, weight7 = 1;

        var rate7_q=0, amount7_q = 0, weight7_q = 0;
        ...
        document.getElementById("weight7").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight7Bill="";
            weight7_q=0;
            showBill7();
        }else{
            weight7_q=this.value;
            weight7Bill="";
            showBill7();
        ...
        function showBill7(){
            ...
            document.getElementById("total7").innerHTML = (rate7*rate7_q*amount7*amount7_q*weight7*weight7_q); // total amount
        }
        </script>
    {{-- 8th --}}
    <script>
        var rate8 = 1, amount8 = 1, weight8 = 1;

        var rate8_q=0, amount8_q = 0, weight8_q = 0;


        var rate8Bill="",amount8Bill="",weight8Bill="";
        ...
        document.getElementById("weight8").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight8Bill="";
            weight8_q=0;
            showBill8();
        }else{
            weight8_q=this.value;
            weight8Bill="";
            showBill8();
        ...
        function showBill8(){
            ...
            document.getElementById("total8").innerHTML = (rate8*rate8_q*amount8*amount8_q*weight8*weight8_q); // total amount
        }
        </script>
    {{-- 9th --}}
    <script>
        var rate9 = 1, amount9 = 1, weight9 = 1;

        var rate9_q=0, amount9_q = 0, weight9_q = 0;


        var rate9Bill="",amount9Bill="",weight9Bill="";
        ...
        document.getElementById("weight9").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight9Bill="";
            weight9_q=0;
            showBill9();
        }else{
            weight9_q=this.value;
            weight9Bill="";
            showBill9();
        ...
        function showBill9(){
            ...
            document.getElementById("total9").innerHTML = (rate9*rate9_q*amount9*amount9_q*weight9*weight9_q); // total amount
        }
        </script>
    {{-- 10th --}}
    <script>
        var rate10 = 1, amount10 = 1, weight10 = 1;

        var rate10_q=0, amount10_q = 0, weight10_q = 0;


        var rate10Bill="",amount10Bill="",weight10Bill="";
        ...
        document.getElementById("weight10").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight10Bill="";
            weight10_q=0;
            showBill10();
        }else{
            weight10_q=this.value;
            weight10Bill="";
            showBill10();
        ...
        function showBill10(){
            ...
            document.getElementById("total10").innerHTML = (rate10*rate10_q*amount10*amount10_q*weight10*weight10_q); // total amount
        }
        </script>
    ...
    {{-- 11th --}}
    <script>
        var rate11 = 1, amount11 = 1, weight11 = 1;

        var rate11_q=0, amount11_q = 0, weight11_q = 0;


        var rate11Bill="",amount11Bill="",weight11Bill="";
        ...
        document.getElementById("weight11").addEventListener("keyup",function(){
        if(this.value==""||this.value==0){
            weight11Bill="";
            weight11_q=0;
            showBill11();
        }else{
            weight11_q=this.value;
            weight11Bill="";
            showBill11();
    ...
    function showBill11(){
            ...
            (rate11*rate1_q*amount1*amount1_q*weight1*weight1_q)
            +(rate2*rate2_q*amount2*amount2_q*weight2*weight2_q)
            +(rate3*rate3_q*amount3*amount3_q*weight3*weight3_q)
            +(rate4*rate4_q*amount4*amount4_q*weight4*weight4_q)
            +(rate11*rate5_q*amount5*amount5_q*weight5*weight5_q)
            +(rate11*rate6_q*amount6*amount6_q*weight6*weight6_q)
            +(rate7*rate7_q*amount11*amount7_q*weight7*weight7_q)
            +(rate8*rate8_q*amount8*amount8_q*weight8*weight8_q)
            +(rate9*rate9_q*amount9*amount9_q*weight9*weight9_q)
            +(rate10*rate10_q*amount10*amount10_q*weight10*weight10_q)
            +(rate11*rate11_q*amount11*amount11_q*weight11*weight11_q);
