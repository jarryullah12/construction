                ...
                <div class="row" style="padding-left: 10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="/maal_saalas/edit_water_wood_work_list" class="form-horizontal form-material" method="POST">
                                    @csrf
                                    ...
                                    {{-- <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <select type="text" value={{$data['muhala']}} name="muhala" style="text-align: center; font-weight:600; font-size:20px;font-family: Jameel Noori;border: 1px solid gray;font-size:20px;"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" name="per_foot" value={{$data['per_foot']}}
                                                class="form-control border-1" dir="auto" style="border: 1px solid gray; font-size:20px;"  > </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" name="adaigi" value={{$data['adaigi']}}
                                                class="form-control border-1" dir="auto" style="border: 1px solid gray; font-size:20px;"  > </div>
                                    </div>
