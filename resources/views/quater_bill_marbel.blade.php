            ...
            <th style="text-align:right;font-size:18px;font-family: Jameel Noori;border: #fff;"><input  style="width: 230px; height:30px; border:#fff; border-bottom: 1px solid black; text-align:center" type="text"  dir="rtl"><strong> :مقام
                    ...
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color1" ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color2" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color3" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color4" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color5" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color6" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color7" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color8" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color9" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color10" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
                        ...
                        <tr>
                            ...
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" id="color11" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text" style="font-family: Jameel Noori;" ></td>
                            <td dir="auto"><input type="text"  ></td>
