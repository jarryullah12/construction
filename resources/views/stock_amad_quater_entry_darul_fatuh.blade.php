        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-yellow" style="background-color: rgb(223, 223, 223)">
                ...
                <div class="row align-items-center">
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;"><b> اسٹاک کوارٹرز دارالفتوح
                        </b></h3>
                    </div>
                ...
                <div class="row" style="padding-left:10px;">
                    ...
                    <div class="col-lg-6 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_quater_entry_darul_fatuh">
                                    @csrf
...
<div class="col-lg-6 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_quater_entry_darul_fatuh_marbel" class="form-horizontal form-material" method="POST">
                @csrf
...
<br><br>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-lg-6 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_fatuh">
                                    @csrf
 ...
 <div class="col-lg-6 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_fatuh_carpenter">
                @csrf
 ...
 <div class="col-lg-6 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_fatuh_painter">
                @csrf
 ...
 <div class="col-lg-6 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_quater_entry_fatuh_cable_dict" class="form-horizontal form-material" method="POST">
                @csrf
