                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/steel_tameer_list_search">
                                    ...
                                    <table id="customers" class="js-serial">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">  وزن( کلو گرام)</th>

                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">  ریٹ</th>
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">  وزن(فی کلو گرام)</th>
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_steel_tameer/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        {{-- <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-danger"><a  style="color: white;" href={{"steel_tameer_delete/" . $col['id']}}>ختم کریں</a></button></td> --}}
                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['rate']*$col['weight']*$col['amount']}}</td>
                                        <td style="font-size:16px;font-family: Jameel Noori;width:1000px;">{{$col['detail']}}</td>
                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['rate']*$col['weight']}}</td>

                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['rate']}}</td>

                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['weight']}}</td>
                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['amount']}}</td>

                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['muhala']}}</td>

                                        <td style="font-size:16px;font-family: Jameel Noori;width:100px;">{{$col['decorator_name']}}</td>
