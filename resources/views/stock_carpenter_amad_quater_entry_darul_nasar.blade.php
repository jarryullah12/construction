                ...
                <div class="row" style="padding-left:10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                    <h3 style="text-align:center; padding-bottom: 40px; font-weight: 600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک  کارپنٹر</h3>
...
{{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_darul_nasar">
                @csrf
        ...
        --}}
        <form method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_darul_nasar">
            @csrf
            ...
            <div class="form-group " id="fieldGroupCopy" style="display: none;">
                        ...
                        <div class="row" >
                            ...
                            <div class="input-group"  >
                                ...
                                <!-- <div style="width: 60px">
                                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> سائز </b></label>
                                    <input type="number" name="size[]" class="form-control" style="border: 1px solid black" required="required"/>
                                    </div>
                                    &nbsp; -->
                                <div style="width: 500px">
                                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> تفصیل  </b></label>
