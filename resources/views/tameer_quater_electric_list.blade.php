                            ...
                            <div class="table-responsive">
                                ...
                                <div class="topnav">
                                    ...
                                    <div class="search-container">
                                      <form action="/maal_saalas/tameer_quater_electric_list_search">
                                        <input type="text" placeholder=".............. تلاش کریں ................." name="query">
                                    ...
                                    <table id="customers" class="js-serial">
                                        <tr>
                                            ...
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">ٹوٹل قسط رقم </th>
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">قسط </th>
                                            ...
                                            <th style="text-align: center; font-size: 20px; font-family: Jameel Noori;">کورڈ ایریا </th>
                                      ...
                                      @foreach($cols  as $col)
                                      <tr>
                                        <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-success"><a  style="color: white;" href={{"edit_tameer_quater_electric/" . $col['id']}}>تبدیل کریں</a></button></td>
                                        {{-- <td style="text-align: center; font-size: 18px; font-family: Jameel Noori;width:150px;"><button class="btn btn-danger"><a  style="color: white;" href={{"delete_tameer_quater_wood/" . $col['id']}}>ختم کریں</a></button></td> --}}

                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['qisth']-$col['security_rate']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['qisth']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{($col['covered_area']*$col['rate']/$col['adaigi'])}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['security_rate']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:1000px;">{{$col['detail']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['adaigi']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['rate']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:250px;">{{$col['covered_area']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:180px;">{{$col['store_name']}}</td>
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:180px;">{{$col['muhala']}}</td>
