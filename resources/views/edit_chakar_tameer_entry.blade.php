        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;"><b> اسٹاک کرایہ چکر
                        </b></h3>
                    </div>
                ...
                <div class="row" style="padding-left:10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/edit_chakar_quater_entry">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="chakar" value={{$data['chakar']}}
                                                class="form-control border-1" style="border: 1px solid gray;font-size:20px;" dir="auto"> </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> ٹوٹل </b></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" name="total" value="{{$data['total']}}"
