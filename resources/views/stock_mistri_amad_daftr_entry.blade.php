...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
 ...
 {{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_mistri_amad_daftr_entry">
                @csrf
                <h3 style="text-align:center; padding-bottom: 40px; font-weight: 600; font-size: 25px; font-family: Jameel Noori;"> اسٹاک سول ورکس</h3>
                ...
                <div class="form-group mb-4">
                    <label  style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>  دفتر کا نام  </b></label>
                                ...
                                <select class="select2 form-control " name="daftr_no" style="border: 1px solid gray;font-size:20px;">
...
<form method="POST" action="/maal_saalas/stock_mistri_amad_daftr_entry">
    @csrf
