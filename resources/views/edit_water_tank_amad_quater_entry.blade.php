                ...
                <div class="row" style="padding-left: 10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="/maal_saalas/edit_water_tank_amad_quater_entry" class="form-horizontal form-material" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> تفصیل آمد ایڈریس </b></label>
                                                 <div class="col-md-12 border-bottom p-0">
                                                    <input name="detail"  rows="5" class="form-control  border-1" style="border: 1px solid gray; font-size:20px;" value={{$data['detail']}}  dir="auto"  required="required">
                                                </div>
