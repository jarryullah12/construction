            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;"><b> درخواست مرمت دفاتر/گیسٹ ہاوس
                            </b></h3>
                ...
                <div class="row" style="padding-left: 10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/maal_saalas/amad_daftr_letter_update" class="form-horizontal form-material" >
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> تاریخ </b></label>
                                            <input type="text" style="text-align: center;border: 1px solid gray;font-size:20px;" value={{$data['date']}} name="date"
                                    ...
                                    <div class="form-group mb-4">
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>  دفتر/گیسٹ ہاوس  </b></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="daftr_no" value={{$data['daftr_no']}}
                                                class="form-control border-1" style="border: 1px solid gray;font-size:20px;"  dir="auto"  > </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b> تفصیل </b></label>
                                                 <div class="col-md-12 border-bottom p-0">
                                                    <input type="text" name="detail" value={{$data['detail']}} rows="5" class="form-control  border-1" style="border: 1px solid gray;font-size:20px;" dir="auto" >
                                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <div style="text-align:center;">
                                            <button type="submit" style="color: white; background-color: #2f323e; font-size: 25px; font-family: Jameel Noori; width: 120px; height: 40px; border-color: #2f323e; border-radius: 5px;">  تبدیل کرِیں</button>
