                ...
                <div class="row" style="padding-left:10px;">
                    ...
                    <div class="col-lg-6 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_quater_entry_darul_sadar" >
                                    @csrf
...
<div class="col-lg-6 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_quater_entry_darul_sadar_marbel" class="form-horizontal form-material" method="POST">
                @csrf
...
<br><br><br>
 ...
 <div class="col-lg-6 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_sadar_carpenter">
                @csrf
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>تاریخ</b></label>
                        <div class="col-md-12 border-bottom p-0">
                            <input type="text" name="date" id="cald7" placeholder="تاریخ سلیکٹ کریں"
                                class="form-control border-1" dir="auto" style="border: 1px solid gray; font-size:20px; text-align:center"  required="required"> </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-lg-6 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_sadar">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            <label style="float:right; font-size: larger; font-size: 25px; font-family: Jameel Noori;"><b>تاریخ</b></label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="text" name="date" id="cald2" placeholder="تاریخ سلیکٹ کریں"
                                                    class="form-control border-1" dir="auto" style="border: 1px solid gray; font-size:20px; text-align:center"  required="required"> </div>
                                        </div>
                                    </div>
{{--
 ...
 <div class="col-lg-6 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_amad_quater_entry_darul_sadar_painter">
                @csrf
  ...
  <div class="col-lg-6 col-xlg-9 col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" action="/maal_saalas/stock_quater_entry_darul_sadar_cable_dict" class="form-horizontal form-material" method="POST">
                @csrf
