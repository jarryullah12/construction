...
{{-- 2nd form --}}
<form method="POST" action="/maal_saalas/stock_carpenter_yomiya_quater_entry_darul_waqfeen">
@csrf
        ...
        <div class="input-group"  >
           ...
           <div style="width: 80px">
            ...
            <div style="width: 130px">
                ...
                <select  type="text" name="waqfeen_quater_no[]" class="form-control select2" style="border: 1px solid black" required="required"  >
            ...
            <div class="row" >
                ...
                <div class="input-group"  >
                    ...
                    <div style="width: 130px">
                        ...
                        <select  type="text" name="waqfeen_quater_no[]" class="form-control " style="border: 1px solid black" required="required" >
