...
use App\Http\Controllers\quater_tameer_controller;
  ...
  $total=quater_tameer_controller::tameer_quater_paint();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<form method="POST" action="/maal_saalas/amad_tameer_quater_painter">
    @csrf
        <div class="form-group fieldGroup">
            ...
            <div class="input-group"  >
                ...
                <div style="width: 180px">
                    ...
                    <input type="text" dir="auto" name="per_murabah_rate[]" class="form-control" style="border: 1px solid black" />
                    </div>
                    &nbsp;
                <div style="width: 180px">
                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> رقبہ </b></label>
                    <input type="text" dir="auto" name="rakbah[]" class="form-control" style="border: 1px solid black" />
                    </div>
                    &nbsp;
    ...
    <div class="form-group " id="fieldGroupCopy" style="display: none;">
                ...
                <div class="row" >
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 180px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> فی مربع ریٹ </b></label>
                            <input type="text" name="per_murabah_rate[]" dir="auto" class="form-control" style="border: 1px solid black" />
                            </div>
                            &nbsp;
                        <div style="width: 180px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> رقبہ </b></label>
                            <input type="text" name="rakbah[]" dir="auto" class="form-control" style="border: 1px solid black" />
                            </div>
                            &nbsp;
