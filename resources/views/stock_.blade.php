...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_sadar_painter();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
 ...
 {{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_painter_amad_quater_entry_darul_sadar">
                @csrf
...
<form method="POST" action="/maal_saalas/stock_painter_amad_quater_entry_darul_sadar">
    @csrf
        <div class="form-group fieldGroup">
            ...
            <div class="input-group"  >
                ...
                <div style="width: 120px">
                    ...
                    <input type="number" dir="auto" name="per_murabah_rate[]" class="form-control" style="border: 1px solid black" />
                    </div>
                    &nbsp;
                <div style="width: 120px">
                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> رقبہ </b></label>
                    <input type="number" dir="auto" name="rakbah[]" class="form-control" style="border: 1px solid black" />
                    </div>
                    &nbsp;
                ...
                <div style="width: 160px">
                    ...
                    <input type="text" dir="auto" name="painter_name[]" class="form-control" style="border: 1px solid black" />
                    </div>
                    &nbsp;
                    <div style="width: 120px">
                ...
                <div style="width: 230px">
                    ...
                    <select  type="text" name="quater_no[]" class="form-control select2" style="border: 1px solid black" >

                    <option style="text-align: center;">سلیکٹ کریں</option>
                    @foreach ($cols as $col)
                    <option style="text-align: center;" value="{{$col['quater_no']}}">{{$col['quater_no']}}</option>
                    @endforeach
    ...
    <div class="form-group " id="fieldGroupCopy" style="display: none;">
                ...
                <div class="row" >
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 120px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> فی مربع ریٹ </b></label>
                            <input type="number" name="per_murabah_rate[]" dir="auto" class="form-control" style="border: 1px solid black" />
                            </div>
                            &nbsp;
                        <div style="width: 120px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> رقبہ </b></label>
                            <input type="number" name="rakbah[]" dir="auto" class="form-control" style="border: 1px solid black" />
                            </div>
                            &nbsp;
                        ...
                        <div style="width: 160px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> پینٹر کا نام  </b></label>
                            <input type="text" name="painter_name[]" dir="auto" class="form-control" style="border: 1px solid black" />
                            </div>
                            &nbsp;
                            <div style="width: 120px">
                                <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> بروز </b></label>
                                <input type="text" name="day[]" dir="auto" class="form-control" style="border: 1px solid black" />
                                </div>
                                &nbsp;
                        <div style="width: 230px">
                            <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>

                            <select  type="text" name="quater_no[]" class="form-control " style="border: 1px solid black" >
                        ...
                        &nbsp;
                        <div style="width: 200px">
                            <input type="hidden" value="{{0}}" name="date[]" class="form-control" class="col-md-2" style="border: 1px solid black" />
                            </div>
                    </div>
