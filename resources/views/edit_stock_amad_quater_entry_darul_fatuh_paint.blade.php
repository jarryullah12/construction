        ...
        <div class="page-wrapper">
            ...
            <div  class="container-fluid" >
                ...
                <div class="row" style="padding-left:10px;">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="/maal_saalas/edit_stock_amad_quater_entry_darul_fatuh_paint">
                ...
                <div class="form-group mb-4">
                    ...
                    <select  type="text" name="kaam"  class="form-control " style="border: 1px solid gray;font-size: 20px;" >
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-md-12 border-bottom p-0">
                        <input type="text" name="rakbah" value="{{$data['rakbah']}}"
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="col-md-12 border-bottom p-0">
                        <input type="text" name="per_murabah_rate" value="{{$data['per_murabah_rate']}}"
                            class="form-control border-1" style="border: 1px solid gray;font-size:20px;"  dir="auto" > </div>
                </div>
