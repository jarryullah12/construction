...
{{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_factory_area">
                @csrf
        ...
        <form method="POST" action="/maal_saalas/stock_carpenter_amad_quater_entry_factory_area">
            @csrf
                        ...
                        <div class="row" >
                            ...
                            <div class="input-group"  >
                                ...
                                <div style="width: 130px">
                                    ...
                                    {{-- <div style="width: 100px">
                                        <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b> بروز </b></label>
                                        <input type="text" name="day[]" class="form-control" style="border: 1px solid black" />
                                        </div>
                                        &nbsp; --}}
                                <div style="width: 130px">
                                    <label  style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>

                                    <select  type="text" name="factory_quater_no[]" class="form-control " style="border: 1px solid black" required="required">
