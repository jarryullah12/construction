        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-yellow" style="background-color: rgb(223, 223, 223)">
                ...
                <div class="row align-items-center">
                    ...
                    <div >
                        <h3 style="padding-left: 600px; font-size: 25px; font-family: Jameel Noori;" ><b>   اسٹور کوارٹرز</b> </h3>
                    </div>
                            ...
                            <div class="table-responsive">
                                    ...
                                    <table id="customers"  class="js-serial">
                                      ...
                                      <tr>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:100px;">{{$col['detail']}}</td>
                                        ...
                                        <td style="text-align: right; font-size: 18px; font-family: Jameel Noori;width:150px;">{{$col['ishya_name']}}</td>
