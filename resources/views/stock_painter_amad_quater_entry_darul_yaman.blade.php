...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_yaman_painter();
?>
@if(Session::has('user'))
{{ View::make('header')}}
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
 ...
 {{-- <div class="col-lg-12 col-xlg-9 col-md-2">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" method="POST" action="/maal_saalas/stock_painter_amad_quater_entry_darul_yaman">
                @csrf
        ...
        <form method="POST" action="/maal_saalas/stock_painter_amad_quater_entry_darul_yaman">
            @csrf
                <div class="form-group fieldGroup">
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 230px">
                            ...
                            <select  type="text" name="yaman_quater_no[]" class="form-control select2" style="border: 1px solid black" >
