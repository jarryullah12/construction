...
{{-- 2nd form --}}
<form method="POST" action="/maal_saalas/stock_carpenter_yomiya_quater_entry_darul_fatuh">
@csrf
        ...
        <div class="input-group"  >
           ...
           <div style="width: 80px">
            ...
            <div style="width: 130px">
                ...
                <select  type="text" name="fatuh_quater_no[]" class="form-control select2" style="border: 1px solid black" required="required"  >
