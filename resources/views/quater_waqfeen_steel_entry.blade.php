...
use App\Http\Controllers\quater;
  ...
  $total=quater::cartItem_waqfeen_steel();
?>
@if(Session::has('user'))
    {{ View::make('header')}}
...
<form method="POST" action="/maal_saalas/quater_waqfeen_steel_entry">
    @csrf
            ...
            <div class="input-group"  >
                ...
                <div style="width: 140px">
                    <label style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>
                                ...
                                <select class="form-control select2" name="waqfeen_quater_no[]" style="border: 1px solid gray;font-size:14px;">
                    ...
                    <div class="input-group"  >
                        ...
                        <div style="width: 140px">
                            <label style="float:right; font-size: larger; font-size: 16px; font-family: Jameel Noori; "><b>   کوارٹر نمبر  </b></label>
                                        ...
                                        <select class="form-control " name="waqfeen_quater_no[]" style="border: 1px solid black;font-size:14px;">
                                           <option style="text-align: center;">سلیکٹ کریں</option>
                                           @foreach ($cols as $col)
                                           <option value="{{$col['waqfeen_quater_no']}}">{{$col['waqfeen_quater_no']}}</option>
                                           @endforeach
